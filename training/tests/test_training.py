...
class ArtifactTests(unittest.TestCase):
    def test_prefix_encoder_matches_runtime_golden_artifact(self) -> None:
        ...
        expected = bytes.fromhex(
            "4c41454d4f444c00010000004000000054000000079f66560800010001000000"
        ...
        self.assertEqual(struct.unpack_from("<I", artifact, 20)[0], 0x56669F07)
        checksum_input = bytearray(artifact)
        struct.pack_into("<I", checksum_input, 20, 0)
        self.assertEqual(zlib.crc32(checksum_input) & 0xFFFFFFFF, 0x56669F07)
